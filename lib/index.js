...
module.exports = function modelBase (bookshelf, params) {
  ...
  var model = bookshelf.Model.extend({
    ...
    findOrCreate: function (data, options = {}) {
      var Model = this
      return Model.findOne(data, Object.assign({}, options, { require: false }))
        .then(function (model) {
          var defaults = (options && options.defaults) || {}
          return model || Model.create(Object.assign(defaults, data), options)
        })
    },
    ...
    upsert: function (selectData, updateData, options = {}) {
      var Model = this
      return Model.findOne(selectData, Object.assign({}, options, { require: false }))
        .then(function (model) {
          return model
            ? model.save(
              updateData,
